...
{   
    public partial class frmUrheilutiedotJalkapallo : Form
    {               
        public frmUrheilutiedotJalkapallo()
        {
            InitializeComponent();           
        }
        ...
        public void btnStart_Click(object sender, EventArgs e)
        {
            ...
            //Luodaan pelien tiedosto/kirjoitetaan tiedostoon uusi peli
        ...
        //Asettaa kellon toiminnan ja jos 45min tulee täyteen kello pysäytetään, ja nappulat poistetaan käytöstä
        bool ehto = true;
        int sec = 0, min = 0;       
